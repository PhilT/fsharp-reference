...
Once Chocolatey is installed you can install Neovim QT very easily:

```
cinst neovim
```

It's best to run from CMD or Powershell or a shortcut as Bash has some strange behaviour.
I've had crashes and certain plugins not working correctly (e.g. FZF).
